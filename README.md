This is based on kevinvincent's (https://github.com/kevinvincent/ha-wyzesense) work for the wyzesense platform. I've updated the code for Home Assistant's latest best practices.
